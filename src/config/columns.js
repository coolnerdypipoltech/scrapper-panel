...
export const TT_COLS = [
  ...
  { key: "authorMeta.nickName", label: "Nickname", type: "text" },
  { key: "authorMeta.fans", label: "Fans", type: "number" },
  { key: "authorMeta.heart", label: "Likes del Usuario", type: "number" },
  { key: "webVideoUrl", label: "URL", type: "link" },
];

export const FB_COLS = [
  {
    key: "author.profile_picture_url",
    label: "",
    type: "fb-thumbnail",
    linkKey: "author.profile_picture_url",
  },
  {
    key: "author.name",
    label: "Autor",
...
export const IG_COLS = [
  ...
  { key: "profileFullName", label: "Nombre perfil", type: "text" },
  { key: "profileUsername", label: "Usuario perfil", type: "text" },
  { key: "profilePostsCount", label: "Posts autor", type: "number" },
  { key: "profileFollowersCount", label: "Followers", type: "number" },
  { key: "profileFollowsCount", label: "Following", type: "number" },
  { key: "caption", label: "Caption", type: "text", truncate: true },
  { key: "likesCount", label: "Likes/Posts", type: "number" },
  { key: "commentsCount", label: "Comentarios", type: "number" },
...
export const FB_EXCEL_COLS = [
  ...
  },
  {
    ...
    width: 20,
    srcKey: "timestamp",
    transform: (v) => (v ? new Date(Number(v)).toLocaleDateString("es") : ""),
  },
...
export const IG_EXCEL_COLS = [
  ...
  { header: "Nombre perfil", key: "nombre_perfil_ig", width: 28, srcKey: "profileFullName" },
  { header: "Usuario perfil", key: "usuario_perfil_ig", width: 22, srcKey: "profileUsername" },
  { header: "Posts autor", key: "posts_autor_ig", width: 14, srcKey: "profilePostsCount" },
  { header: "Followers", key: "followers_autor_ig", width: 14, srcKey: "profileFollowersCount" },
  { header: "Following", key: "following_autor_ig", width: 14, srcKey: "profileFollowsCount" },
...
export const GN_EXCEL_COLS = [
  ...
  },
  {
    ...
    key: "keyword_gn",
    width: 20,
    srcKey: "metadata.keyword",
  },
  {
    header: "Timeframe",
    key: "timeframe_gn",
    width: 12,
    srcKey: "metadata.timeframe",
  },
